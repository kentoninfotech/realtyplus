            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            @if(!auth()->user()->hasrole('Client'))
                               <div class="list-group">
                                    ...
                                    <a href="{{ url('/project/'.$project->id) }}/reports"
                                        class="list-group-item list-group-item-action">Reports</a>
                                    <a href="{{ url('/project/'.$project->id) }}/tasks"
                                        class="list-group-item list-group-item-action">Tasks</a>
                                    <a href="{{ url('/project/'.$project->id) }}/milestones"
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <p
                            style="text-align: left>{!! $project->details !!}</p>
                    </div>
                    <hr>
